...
$(document).on('click', '#LoadMore', function () {
    $.ajax({
        ...
        data: {
            ...
            flagContinue: true,
            lastPostId: lastJob.key.jobId,
            lastPostTime: lastJob.key.postTime
        },
        success: function (listOfJobs) {
            deleteWall();
            listOfJobs.forEach(printJobOffer);
...
// language=HTML
    $('\
    <div class="row" id="feed"' + job.jobId + '>\
            ...
            <div class="panel-body">\
                    <img class="col-sm-2" id="businessImg" src=""  >\
                    <div class="col-md-2-12" style="text-align: left;">\
    ...
    if ($("#businessImg").val() != null) {
        $("#businessImg").attr("src", business.profilePicUrl);
    }
    else {
        $("#businessImg").hide();
    }
